...
class Brain(object):
    ...
    def pose_template(self):
        return {
            ...
            "prepare_action_huge": self.prepare_action_huge,
            ...
            "push_up_prepare": self.push_up_prepare,
            ...
            "keep_body_stable_right": self.keep_body_stable_right,
            "keep_body_stable_left": self.keep_body_stable_left,
            ...
            "hands_up_right_traverse": self.hands_up_right_traverse,
            "hands_up_left_traverse": self.hands_up_left_traverse,
            "hands_up_shoulder": self.hands_up_shoulder,
            ...
            "hands_down_jump": self.hands_down_jump,
            "hands_down_left_traverse": self.hands_down_left_traverse,
            "hands_down_right_traverse": self.hands_down_right_traverse,
            "hands_down_incline": self.hands_down_incline,
            ...
            "ending_left_traverse": self.ending_left_traverse,
            "ending_right_traverse": self.ending_right_traverse,
            "ending_shoulder": self.ending_shoulder
    ...
    def prepare_action_huge(self):  # 與預備動作差異太大
        return self.abs_compare("left_shoulder_x", "left_shoulder_x_temp", ">", 100) or \
            self.abs_compare("right_shoulder_x", "right_shoulder_x_temp", ">", 100) or \
            self.abs_compare("right_knee_x", "right_knee_x_temp", ">", 100) or \
            self.abs_compare("left_knee_x", "left_knee_x_temp", ">", 100)
    ...
    def drop_hand_natrually_right(self):
        return self.abs_compare("right_hip_y", "right_wrist_y", ">", 60)

    def drop_hand_natrually_left(self):
        return self.abs_compare("left_hip_y", "left_wrist_y", ">", 60) 

    def push_up_prepare(self):
        return self.human.angles["left_shoulder_angle"] > 120 or \
            self.abs_compare("left_shoulder_y", "left_knee_y", ">", 400) 
    ...
    def hold_dumbbel_shoulder(self):  # 雙手持啞鈴於肩膀兩側
        return self.abs_compare("right_shoulder_y", "right_wrist_y", ">", 80) or \
            self.abs_compare("left_shoulder_y", "left_wrist_y", ">", 80)
    ...
    def keep_body_stable_right(self):
        return self.abs_compare("right_hip_x", "right_hip_x_temp", ">", 70) or \
            self.abs_compare("right_knee_x", "right_knee_x_temp", ">", 70)
    
    def keep_body_stable_left(self):
        return self.abs_compare("left_hip_x", "left_hip_x_temp", ">", 70) or \
            self.abs_compare("left_knee_x", "left_knee_x_temp", ">", 70)
    ...
    def hands_up_right_traverse(self, param=30):
        return self.human.points["right_ankle_x"] < self.human.points["right_ankle_x_temp"] - param

    def hands_up_left_traverse(self, param=30):
        return self.human.points["left_ankle_x"] > self.human.points["left_ankle_x_temp"] + param

    def hands_up_shoulder(self, param=20):
        return self.human.points["left_shoulder_y"] > self.human.points["left_shoulder_y_temp"] + param
    ...
    def hands_down_lift_left(self):
        return self.noabs_compare("right_wrist_y", "left_shoulder_y", "<", -20) and \
            self.noabs_compare("left_wrist_y", "left_shoulder_y", "<", -20)
            #self.noabs_compare("right_wrist_x", "left_shoulder_x", ">", 70) and \
            #sself.noabs_compare("left_wrist_x", "left_shoulder_x", ">", 70) and \
    def hands_down_lift_right(self):
        return self.noabs_compare("right_wrist_y", "right_shoulder_y", "<", -20) and \
            self.noabs_compare("left_wrist_y", "right_shoulder_y", "<", -20)
            #self.noabs_compare("right_wrist_x", "right_shoulder_x", "<", -70) and \
    ...
    def hands_down_jump(self):
        return self.noabs_compare("right_ankle_y_temp", "right_ankle_y", ">", 40) and \
            self.noabs_compare("left_ankle_y_temp", "left_ankle_y", ">", 40)

    def hands_down_right_traverse(self):
        return self.human.points["right_ankle_x"] < self.human.points["right_ankle_x_temp"] - 70
    
    def hands_down_left_traverse(self):
        return self.human.points["left_ankle_x"] > self.human.points["left_ankle_x_temp"] + 70
        
    def hands_down_incline(self):
        return self.human.points["left_shoulder_y"] > self.human.points["left_shoulder_y_temp"] + 50
    ...
    def ending_left_traverse(self):
        return not self.hands_up_left_traverse(param=10)
    
    def ending_right_traverse(self):
        return not self.hands_up_right_traverse(param=10)

    def ending_shoulder(self):
        return not self.hands_up_shoulder(param=10)
